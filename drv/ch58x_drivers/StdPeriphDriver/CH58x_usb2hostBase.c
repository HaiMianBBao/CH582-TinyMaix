...
__attribute__((aligned(4))) const UINT8  SetupClrU2SetIdle[] = { 0x21,0x0a,0x00,0x00,0x00,0x00,0x00,0x00};
/*********************************************************************
 ...
 *          ERR_SUCCESS         数据交换成功
 */
uint8_t U2HostCtrlTransfer(uint8_t *DataBuf, uint16_t *RetLen)
{
    uint16_t RemLen = 0;
...
UINT8 CtrlSetUsb2Idel(void)
{    
    CopyU2SetupReqPkg((PCHAR)SetupClrU2SetIdle); 
